        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 15, "theamazingrace.jpg", 32, "The Amazing Race", "TV-PG" },
                    { 14, "blindspot.jpg", 5, "Blind Spot", "TV-14" },
                    { 13, "newgirl.jpg", 7, "New Girl", "TV-14" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "placeholder text", "placeholder rating", 12, 2 },
                    { 6, "placeholder text", "placeholder rating", 15, 2 },
                    { 3, "placeholder text", "placeholder rating", 13, 3 },
                    { 4, "placeholder text", "placeholder rating", 3, 4 },
                    { 5, "placeholder text", "placeholder rating", 8, 4 },
                    { 2, "placeholder text", "placeholder rating", 15, 7 }
                });
        }
